...
void _testDeeplinkNotifier() {
  group('Deeplink Notifier Test', () {
    ...
    test('stream uri', () {
      final container = ProviderContainer();
      final uri1 = Uri.parse('otpauth://hotp/issuer?secret=AAAAAAAA&counter=0&digits=6&algorithm=SHA1');
      final uri2 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=30&digits=6&algorithm=SHA1');
      final uri3 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=60&digits=6&algorithm=SHA1');
      final uri4 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=90&digits=6&algorithm=SHA1');
    ...
    test('stream uri multible', () {
      final container = ProviderContainer();
      final hotp1 = Uri.parse('otpauth://hotp/issuer?secret=AAAAAAAA&counter=1&digits=6&algorithm=SHA1');
      final hotp2 = Uri.parse('otpauth://hotp/issuer?secret=AAAAAAAA&counter=2&digits=6&algorithm=SHA1');
      final hotp3 = Uri.parse('otpauth://hotp/issuer?secret=AAAAAAAA&counter=3&digits=6&algorithm=SHA1');
      final hotp4 = Uri.parse('otpauth://hotp/issuer?secret=AAAAAAAA&counter=4&digits=6&algorithm=SHA1');
      final totp1 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=15&digits=6&algorithm=SHA1');
      final totp2 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=30&digits=6&algorithm=SHA1');
      final totp3 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=60&digits=6&algorithm=SHA1');
      final totp4 = Uri.parse('otpauth://totp/issuer?secret=AAAAAAAA&period=90&digits=6&algorithm=SHA1');

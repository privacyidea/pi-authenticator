...
void main() {
  group('IntroductionState', () {
    test('withCompletedIntroduction add introduction', () {
      const introductionState = IntroductionState(
        completedIntroductions: {Introduction.addFolder},
      );
      final updatedState = introductionState.withCompletedIntroduction(
        Introduction.addManually,
      );
      expect(updatedState.completedIntroductions, {
    ...
    test('withoutCompletedIntroduction remove introduction', () {
      ...
      final updatedState = introductionState.withoutCompletedIntroduction(
        Introduction.addManually,
      );

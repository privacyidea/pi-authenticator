...
void _testPushTokenRolloutstateExtension() {
  group('Push-Token Rolloutstate Extension', () {
    test('rollOutInProgress', () {
      ...
      expect(
        PushTokenRollOutState.generatingRSAKeyPair.rollOutInProgress,
        true,
      );
      expect(
        PushTokenRollOutState.generatingRSAKeyPairFailed.rollOutInProgress,
        false,
      );
      expect(PushTokenRollOutState.sendRSAPublicKey.rollOutInProgress, true);
      expect(
        PushTokenRollOutState.sendRSAPublicKeyFailed.rollOutInProgress,
        false,
      );
      expect(PushTokenRollOutState.parsingResponse.rollOutInProgress, true);
      expect(
        PushTokenRollOutState.parsingResponseFailed.rollOutInProgress,
        false,
      );
    ...
    test('getFailed', () {
      expect(
        PushTokenRollOutState.rolloutNotStarted.getFailed(),
        PushTokenRollOutState.rolloutNotStarted,
      );
      expect(
        PushTokenRollOutState.generatingRSAKeyPair.getFailed(),
        PushTokenRollOutState.generatingRSAKeyPairFailed,
      );
      expect(
        PushTokenRollOutState.generatingRSAKeyPairFailed.getFailed(),
        PushTokenRollOutState.generatingRSAKeyPairFailed,
      );
      expect(
        PushTokenRollOutState.sendRSAPublicKey.getFailed(),
        PushTokenRollOutState.sendRSAPublicKeyFailed,
      );
      expect(
        PushTokenRollOutState.sendRSAPublicKeyFailed.getFailed(),
        PushTokenRollOutState.sendRSAPublicKeyFailed,
      );
      expect(
        PushTokenRollOutState.parsingResponse.getFailed(),
        PushTokenRollOutState.parsingResponseFailed,
      );
      expect(
        PushTokenRollOutState.parsingResponseFailed.getFailed(),
        PushTokenRollOutState.parsingResponseFailed,
      );
      expect(
        PushTokenRollOutState.rolloutComplete.getFailed(),

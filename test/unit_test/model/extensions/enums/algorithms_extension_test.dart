    ...
    group('generateTOTPCodeString', () {
      ...
      group('different interval 60 Seconds', () {
        ...
        test('compare half year 60 sec, 1 year 30 sec & hotp value', () {
          ...
          final hotpValue = Algorithms.SHA1.generateHOTPCodeString(
            secret: 'secret',
            counter: oneYear60SecCounter,
            length: 6,
          );
    ...
    group('generateHOTPCodeString', () {
      group('different couters 6 digits', () {
        test('OTP for counter == 0', () {
          final otpValue = Algorithms.SHA1.generateHOTPCodeString(
            secret: 'secret',
            counter: 0,
            length: 6,
          );
      ...
      group('different algorithms 6 digits', () {
        ...
        test('OTP for sha256', () {
          final otpValue = Algorithms.SHA256.generateHOTPCodeString(
            secret: 'secret',
            counter: 0,
            length: 6,
          );
        ...
        test('OTP for sha512', () {
          final otpValue = Algorithms.SHA512.generateHOTPCodeString(
            secret: 'secret',
            counter: 0,
            length: 6,
          );

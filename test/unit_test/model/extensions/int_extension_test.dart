...
void _testIntExtension() {
  group('int extension', () {
    group('bytes', () {
      test(
        'min int value',
        () => expect((-0x8000000000000000).bytes, [128, 0, 0, 0, 0, 0, 0, 0]),
      );
      test('zero', () => expect(0.bytes, [0, 0, 0, 0, 0, 0, 0, 0]));
      test(
        'max int value',
        () => expect(0x7FFFFFFFFFFFFFFF.bytes, [
          127,
          255,
          255,
          255,
      ...
      test('20 different int values', () {
        expect(8254763140651989312.bytes, [
          114,
          142,
          207,
          87,
        ...
        expect(6233195836444142436.bytes, [
          86,
          128,
          194,
          150,
        ...
        expect(5665252064165200114.bytes, [
          78,
          159,
          4,
          188,
        ...
        expect(4217815205603023728.bytes, [
          58,
          136,
          176,
          149,
        ...
        expect((-1341891893474570224).bytes, [
          237,
          96,
          164,
          110,
        ...
        expect((-1947790576164582988).bytes, [
          228,
          248,
          14,
          202,
        ...
        expect((-5204853149876150168).bytes, [
          183,
          196,
          165,
          162,
        ...
        expect((-5765512478999408848).bytes, [
          175,
          252,
          200,
          242,
        ...
        expect((-6273311771369426144).bytes, [
          168,
          240,
          184,
          46,
        ...
        expect((-6384342681465787276).bytes, [
          167,
          102,
          66,
          40,
        ...
        expect((-6805707171905842232).bytes, [
          161,
          141,
          69,
          98,
        ...
        expect((-7708924412950309696).bytes, [
          149,
          4,
          102,
          23,
        ...
        expect((-7731444997339132318).bytes, [
          148,
          180,
          99,
          188,
        ...
        expect((-7855692611255695686).bytes, [
          146,
          250,
          249,
          48,
        ...
        expect((-9153687162235632943).bytes, [
          128,
          247,
          146,
          6,

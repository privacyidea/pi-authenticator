...
//       Map<String, dynamic> map = qrParser.parseUriToMap(uriWithoutIssuerAndLabel);
...
//       Map<String, dynamic> map = qrParser.parseUriToMap(uriWithIssuerParam);
...
//           '&algorithm=SHA512&digits=8&period=60';
//       Map<String, dynamic> map = qrParser.parseUriToMap(uriWithIssuer);
//       expect(map[URI_LABEL], 'alice@google.com');
...
//           '&algorithm=SHA512&digits=8&period=60';
//       Map<String, dynamic> map = qrParser.parseUriToMap(uriWithIssuerAndUriEncoding);
//       expect(map[URI_LABEL], 'alice@google.com');
//       expect(map[URI_ISSUER], 'Example');
//     });
...
//           '&issuer=ACME%20Co&algorithm=SHA512&digits=8&period=60';
//       Map<String, dynamic> map = qrParser.parseUriToMap(uriWithIssuerParamAndIssuer);
//       expect(map[URI_LABEL], 'alice@google.com');
//       expect(map[URI_ISSUER], 'Example');
//     });
//   });
...
//       expect(
//           () => qrParser.parseUriToMap('http://totp/ACME%20Co:john@example.com?'
...
//       expect(
//           () => qrParser.parseUriToMap('otpauth://asdf/ACME%20Co:john@example.com?'
//               'secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME%20Co'
//               '&algorithm=SHA1&digits=6&period=30'),
//           throwsA(const TypeMatcher<ArgumentError>()));
//     });
...
//       expect(
//           () => qrParser.parseUriToMap('otpauth:///ACME%20Co:john@example.com?'
//               'secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME%20Co'
//               '&algorithm=SHA1&digits=6&period=30'),
//           throwsA(const TypeMatcher<ArgumentError>()));
//     });
...
//       Map<String, dynamic> map = qrParser.parseUriToMap('otpauth://totp/ACME%20Co:john@example.com?'
//           'secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME%20Co'
//           '&digits=6&period=30');
...
//       expect(
//           () => qrParser.parseUriToMap('otpauth://totp/ACME%20Co:john@example.com?'
//               'secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME%20Co'
...
//       Map<String, dynamic> map = qrParser.parseUriToMap('otpauth://totp/Kitchen?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ'
//           '&issuer=ACME%20Co&algorithm=SHA512&digits=8&period=60');
...
//       expect(
//           () => qrParser.parseUriToMap('otpauth://hotp/Kitchen?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ'
...
//       Map<String, dynamic> map = qrParser.parseUriToMap('otpauth://hotp/Kitchen?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ'
...
//     test('is2StepURI', () {
//       expect(
//         qrParser._is2StepURI(Uri.parse(
...
//       expect(
//         qrParser
//             ._is2StepURI(Uri.parse('otpauth://hotp/OATH0001F662?secret=HDOMWJ5GEQQA6RR34RAP55QBVCX3E2RE&counter=1&digits=6&issuer=privacyIDEA&2step_salt=8')),
//         true,
//       );

//       expect(
//         qrParser._is2StepURI(Uri.parse('otpauth://hotp/OATH0001F662?secret=HDOMWJ5GEQQA6RR34RAP55QBVCX3E2RE&counter=1&digits=6&issuer=privacyIDEA')),
//         false,
//       );
//     });
//   });

  ...
  group('Otp Auth Processor Test', () {
    group('TOTP', () {
      test('processUri', () async {
        ...
        expect(token0.origin, isNull);
        final totpToken = token0 as TOTPToken;
        expect(totpToken.origin, isNull);
    ...
    group('HOTP', () {
      test('processUri', () async {
        ...
        expect(hotpToken.origin, isNull);
    ...
    group('DayPassword', () {
      test('processUri', () async {
        ...
        expect(dayPasswordToken.origin, isNull);
    ...
    group('Push Token', () {
      test('processUri', () async {
        ...
        expect(pushToken.origin, isNull);

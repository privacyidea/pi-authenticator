...
void main() {
  ...
  testWidgets('2step rollout test', (tester) async {
...
Future<void> _addTwoStepHotpTokenTest(WidgetTester tester) async {
  ...
  await pumpUntilFindNWidgets(
    tester,
    find.text(AppLocalizationsEn().phonePart),
    1,
  ...
  await pumpUntilFindNWidgets(
    tester,
    find.byType(HOTPTokenWidgetTile),
    1,
    timeout: const Duration(seconds: 10),
  );
}
...
Future<void> _addTwoStepTotpTokenTest(WidgetTester tester) async {
  ...
  await pumpUntilFindNWidgets(
    tester,
    find.byType(TOTPTokenWidgetTile),
    1,
    timeout: const Duration(seconds: 10),
  );

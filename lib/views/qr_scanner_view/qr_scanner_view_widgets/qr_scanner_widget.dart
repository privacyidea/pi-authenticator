...
Result? _scanQrCodeIsolate(List args) {
  final CameraImage cameraImage = args[0] as CameraImage;
  final int rotation = args[1] as int;
  final double borderPaddingPercent = args[2] as double;
...
class _QRScannerWidgetState extends State<QRScannerWidget> {
  ...
  Future<void> _scanQrCode(CameraImage cameraImage, int rotation, double borderPaddingPercent) async {
    try {
      final result = await compute<List, Result?>(_scanQrCodeIsolate, [cameraImage, rotation, borderPaddingPercent]);

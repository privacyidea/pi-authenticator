...
extension IntroductionX on Introduction {
  ...
  bool isConditionFulfilled(
    ...
    Introduction.introductionScreen => state.isUncompleted(
      Introduction.introductionScreen,
    ),
    Introduction.scanQrCode => state.isUncompleted(Introduction.scanQrCode),
    Introduction.addManually =>
      state.isCompleted(Introduction.scanQrCode) &&
          state.isUncompleted(Introduction.addManually),
    Introduction.tokenSwipe =>
      ref.watch(tokenProvider).value?.tokens.isNotEmpty == true &&
    ...
    Introduction.editToken =>
      state.isCompleted(Introduction.tokenSwipe) &&
          state.isUncompleted(Introduction.editToken),
    Introduction.lockToken =>
      state.isCompleted(Introduction.editToken) &&
          state.isUncompleted(Introduction.lockToken),
    Introduction.dragToken =>
      ref.watch(tokenProvider).hasValue &&
    ...
    Introduction.pollForChallenges =>
      ref.watch(tokenProvider).hasValue &&
          ref.watch(tokenProvider).value!.pushTokens.firstOrNull?.isRolledOut ==
              true &&
          state.isCompleted(Introduction.tokenSwipe) &&
    ...
    Introduction.homeWidgetSetUp => state.isUncompleted(
  ...
  String hintText(AppLocalizations localizations) => switch (this) {
    ...
    Introduction.homeWidgetSetUp => 'Not implemented',
    Introduction.homeWidgetBatteryOptimization => 'Not implemented',
  };
}

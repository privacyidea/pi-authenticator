...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Use device language" : MessageLookupByLibrary.simpleMessage("Use device language"),
    "Use device language if it is supported, otherwise default to english." : MessageLookupByLibrary.simpleMessage("Use device language if it is supported, otherwise default to english."),

...
abstract class AppLocalizations {
  ...
  /// A11y label for the animated countdown until the next OTP is generated.
  ///
  /// In en, this message translates to:
  /// **'{seconds} Seconds until the next OTP will be generated.'**
  String a11ySecondsUntilNextOTP(int seconds);
  ...
  /// Message for discarding a push request for authentication.
  ///
  /// In en, this message translates to:
  /// **'Please authenticate to reject the request.'**
  String get authToDiscardPushRequest;
  ...
  /// Error message when the user tries to navigate to a screen without providing the necessary context.
  ///
  /// In en, this message translates to:
  /// **'Cannot navigate without context.'**
  String get cannotNavigateWithoutContext;
  ...
  /// Status message when trying to copy from an empty clipboard.
  ///
  /// In en, this message translates to:
  /// **'Clipboard is empty'**
  ...
  /// Title of the add container Dialog
  ///
  /// In en, this message translates to:
  /// **'Add container'**
  String get containerAddDialogTitle;
  ...
  /// Content of the dialog that asks the user if they want to delete the corresponding tokens.
  ///
  /// In en, this message translates to:
  /// **'Do you want to delete the corresponding tokens as well?'**
  String get containerDeleteCorrespondingTokenDialogContent;
  ...
  /// Message when a container has expired and can not be rolled out anymore
  ///
  /// In en, this message translates to:
  /// **'Container {serial} has expired and can not be rolled out anymore'**
  String containerRolloutExpired(String serial);

  /// Content of the dialog that asks the user if they want to send device information.
  ///
  /// In en, this message translates to:
  ...
  String get containerRolloutSendDeviceInfoDialogContent;

  /// Title of the dialog that asks the user if they want to send device information.
  ///
  /// In en, this message translates to:
  /// **'Send device information'**
  String get containerRolloutSendDeviceInfoDialogTitle;
  ...
  /// Button text to delete corresponding tokens after container transfer.
  ///
  /// In en, this message translates to:
  /// **'Remove from this device'**
  String get containerTransferDeleteTokensButtonText;

  /// Message when a container and its corresponding tokens have been successfully removed from the device.
  ///
  /// In en, this message translates to:
  /// **'Container and corresponding tokens successfully removed from this device.'**
  String get containerTransferDeleteTokensSuccessMessage;

  /// Content of the dialog that tells the user that the container transfer was aborted.
  ///
  /// In en, this message translates to:
  /// **'Container transfer aborted.'**
  String get containerTransferDialogContentAborted;
  ...
  /// Error message when a global reference could not be found.
  ///
  /// In en, this message translates to:
  /// **'Could not find globalRef'**
  String get couldNotFindGlobalRef;

  /// Error message when a token could not be found for a widget id.
  ///
  /// In en, this message translates to:
  /// **'Could not find token for widget id: {id}'**
  String couldNotFundTokenForWidgetId(String id);
  ...
  /// Button text to delete corresponding tokens after container deletion.
  ///
  /// In en, this message translates to:
  /// **'Delete all'**
  String get deleteAllButtonText;
  ...
  /// Button text to delete only the container not the corresponding tokens.
  ///
  /// In en, this message translates to:
  /// **'Only container'**
  String get deleteOnlyContainerButtonText;
  ...
  /// Hint of the Textfield in the enter passphrase Dialog
  ///
  /// In en, this message translates to:
  /// **'Passphrase'**
  String get enterPassphraseDialogHint;

  /// Title of the enter passphrase Dialog
  ///
  /// In en, this message translates to:
  /// **'Enter passphrase'**
  String get enterPassphraseDialogTitle;
  ...
  /// Error message when the rollover for a container is not allowed.
  ///
  /// In en, this message translates to:
  /// **'Rollover for this container is not allowed.'**
  String get errorRolloverNotAllowed;
  ...
  /// Error message when unregistering for a container is not allowed.
  ///
  /// In en, this message translates to:
  /// **'Unregistering for this container is not allowed.'**
  String get errorUnregisterNotAllowed;
  ...
  /// Title of the dialog that informs the user about the export of tokens.
  ///
  /// In en, this message translates to:
  /// **'Important information'**
  String get exportTokensHintDialogTitle;
  ...
  /// Error message when the secrets of the tokens could not be renewed.
  ///
  /// In en, this message translates to:
  /// **'Failed to renew secrets'**
  String get failedToRenewSecrets;
  ...
  /// Error message when the file is not available.
  ///
  /// In en, this message translates to:
  /// **'The File is currently not available! Please try again.'**
  ...
  /// Error message when the handshake with the server failed.
  ///
  /// In en, this message translates to:
  /// **'Handshake failed, please check the server certificate and try again.'**
  String get handshakeFailedLongText;
  ...
  /// Error message when the host is invalid for the scheme.
  ///
  /// In en, this message translates to:
  /// **'Invalid host: {host} for scheme: {scheme}'**
  String invalidHostForScheme(String host, String scheme);
  ...
  /// Error message when the entered URL is invalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid URL'**
  ...
  /// Title of the link home widget view.
  ///
  /// In en, this message translates to:
  /// **'Link home widget'**
  String get linkHomeWidgetViewTitle;

  /// Error message when the link does not start with otpauth://.
  ///
  /// In en, this message translates to:
  ...
  /// Error message when the widget id is missing.
  ///
  /// In en, this message translates to:
  /// **'Missing widgetId'**
  String get missingWidgetId;
  ...
  /// Error message when no data is found in the QR code.
  ///
  /// In en, this message translates to:
  /// **'No data found in the QR code.'**
  String get noDataFoundInQrCode;
  ...
  /// Error message when no processor is found for the host.
  ///
  /// In en, this message translates to:
  /// **'No processor found for host: {host}'**
  String noProcessorFoundForHost(String host);
  ...
  ///
  /// In en, this message translates to:
  /// **'The {name} [{value}] not supported'**
  String notSupported(String name, String value);
  ...
  /// Error message when push can't be initialized.
  ///
  /// In en, this message translates to:
  /// **'Push cant be initialized, restart the app and try again.'**
  String get pushInitializeUnavailable;
  ...
  /// Title of the push tokens view.
  ///
  /// In en, this message translates to:
  /// **'Push-Tokens'**
  String get pushTokensViewTitle;
  ...
  /// Button text to renew the secrets of the tokens.
  ///
  /// In en, this message translates to:
  /// **'Renew secrets'**
  String get renewSecretsButtonText;

  /// Content of the dialog that tells the user that the secrets of the tokens can be renewed.
  ///
  /// In en, this message translates to:
  /// **'You can renew the secrets of the tokens. This is useful if you suspect that the secrets have been compromised.'**
  String get renewSecretsDialogText;

  /// Title of the dialog that tells the user that the secrets of the tokens can be renewed.
  ///
  /// In en, this message translates to:
  /// **'Renew Token Secrets'**
  String get renewSecretsDialogTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, one{select the token to be exported} other{select the tokens to be exported}}'**
  ...
  /// Button text to start the container transfer.
  ///
  /// In en, this message translates to:
  /// **'Start transfer'**
  String get startTransferButtonText;
  ...
  /// Content of the dialog that tells the user that the container can be transferred.
  ///
  /// In en, this message translates to:
  /// **'You can transfer the container to another device. The container is transferred via a QR code.'**
  String get transferContainerDialogContent1;

  /// Content of the dialog that tells the user that an active internet connection is required for the container transfer.
  ///
  /// In en, this message translates to:
  /// **'For the process is an active internet connection required.'**
  String get transferContainerDialogContent2;

  /// Title of the dialog that tells the user that the container can be transferred.
  ///
  /// In en, this message translates to:
  /// **'Transfer Container'**
  String get transferContainerDialogTitle;

  /// Error message when the container transfer failed.
  ///
  /// In en, this message translates to:
  /// **'Failed to start transfer.'**
  String get transferContainerFailed;

  /// Content of the dialog that tells the user to scan the QR code on the new device to transfer the container.
  ///
  /// In en, this message translates to:
  /// **'Scan the QR code on the new device to transfer the container.'**
  String get transferContainerScanQrCode;

  /// Content of the dialog that tells the user that the container has been transferred successfully.
  ///
  /// In en, this message translates to:
  /// **'The container has been transferred successfully to another device.'**
  String get transferContainerSuccessDialogContent1;

  /// Content of the dialog that asks the user if they want to delete the container and its corresponding tokens from this device.
  ///
  /// In en, this message translates to:
  /// **'Do you want to delete the container and its corresponding tokens from this device?'**
  String get transferContainerSuccessDialogContent2;

  /// Error message when the two step secret could not be generated, or was canceled.
  ///
  /// In en, this message translates to:
  /// **'The two step secret could not be generated, or was canceled.'**
  String get twoStepSecretFailed;
  ...
  /// Error message when a token could not be created.
  ///
  /// In en, this message translates to:
  /// **'The Token could not be created.'**
  String get unableToCreateToken;

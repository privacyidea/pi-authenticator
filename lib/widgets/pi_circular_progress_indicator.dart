    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: CircularProgressIndicator(
          value: value,
          color: swapColors ? foregroundColor.mixWith(backgroundColor, 0.6).withOpacity(1) : foregroundColor,
          backgroundColor: swapColors ? foregroundColor : foregroundColor.mixWith(backgroundColor, 0.6).withOpacity(1),

...
class ThemeCustomization {
  ...
  const ThemeCustomization({
    ...
    this._pushAuthRequestAcceptColor,
    this._pushAuthRequestDeclineColor,
    this._actionButtonsForegroundColor,
    this._tileDefaultOtpColor,
    this._tileDefaultCountdownColor,
    this._tileSubtitleColor,
    this._navigationBarIconColor,
    this._qrButtonBackgroundColor,
    this._qrButtonIconColor,

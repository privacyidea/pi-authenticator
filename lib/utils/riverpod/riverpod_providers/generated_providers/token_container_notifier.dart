...
// //   String serial;
// //   List<TokenTemplate> templatesByOtps;

// //   ContainerResponse._({
// //     required this.serial,
// //     required this.templatesByOtps,
// //   });

// //   factory ContainerResponse.fromExample(Map<String, Map> example) {
// //     final containerSerial = example['container'] as String;
// //     final tokenTemplates = <TokenTemplate>[];

// //     final templates = example['tokens'] as Map;
// //     templates.forEach((templateKey, value) {
// //       if (templateKey is String) {
// //         tokenTemplates.add(TokenTemplate.withSerial(otpAuthMap: templates[templateKey], serial: templateKey));
// //       } else if (templateKey is List) {
// //         tokenTemplates.add(TokenTemplate.withOtps(otpAuthMap: templates[templateKey], otps: templateKey));
// //       }
// //     });

// //     return ContainerResponse._(
// //       serial: containerSerial,
// //       templatesByOtps: tokenTemplates,
// //     );
// //   }
// // }
